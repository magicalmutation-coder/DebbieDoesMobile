...
- Example: http://YOUR_HOST:3000/api/external
...
- Method: GET
- Path: /health
- Full URL example: http://YOUR_HOST:3000/api/external/health
...
- Method: GET
- Path: /events
- Full URL example: http://YOUR_HOST:3000/api/external/events
- Query params:
...
- Method: POST
- Path: /query
- Full URL example: http://YOUR_HOST:3000/api/external/query
...
- Full URL example: http://YOUR_HOST:3000/api/external/whatsapp/status
...
curl -H "Authorization: Bearer YOUR_EXTERNAL_API_KEY" http://YOUR_HOST:3000/api/external/health

### 6.2 Event Poll

curl -H "Authorization: Bearer YOUR_EXTERNAL_API_KEY" "http://YOUR_HOST:3000/api/external/events?limit=50&topics=mail,whatsapp"
...
curl -X POST \
  ...
  http://YOUR_HOST:3000/api/external/query
